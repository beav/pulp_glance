...
DIRS = ('/var/lib/pulp/published/glance/web',)
...
LINKS = (
    ('plugins/etc/httpd/conf.d/pulp_glance.conf', '/etc/httpd/conf.d/pulp_glance.conf'),
    ('plugins/etc/pulp/server/plugins.conf.d/glance_distributor.json',
     '/etc/pulp/server/plugins.conf.d/glance_distributor.json'),
    ('plugins/types/glance.json', DIR_PLUGINS + '/types/glance.json'),
)
...
def install(opts):
    ...
    os.system('chown -R apache:apache /var/lib/pulp/published/glance')
