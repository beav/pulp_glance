...
from pulp_glance.extensions.admin import pulp_cli
from pulp_glance.extensions.admin import images
...
class TestInitialize(unittest.TestCase):
    def test_structure(self):
        ...
        glance_section = context.cli.root_section.subsections['glance']

        repo_section = glance_section.subsections['repo']
        ...
        self.assertTrue(isinstance(repo_section.commands['list'], ListGlanceRepositoriesCommand))
