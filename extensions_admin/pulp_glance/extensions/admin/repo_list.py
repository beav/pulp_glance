...
class ListGlanceRepositoriesCommand(ListRepositoriesCommand):

    def __init__(self, context):
        repos_title = _('Glance Repositories')
        super(ListGlanceRepositoriesCommand, self).__init__(context, repos_title=repos_title)
    ...
    def get_repositories(self, query_params, **kwargs):
        """
        Get a list of all the glance repositories that match the specified query params
        ...
        :type kwargs: dict
        :return: List of glance repositories
        :rtype: list of dict
        """
        ...
        for repo in all_repos:
            ...
            if pulp_constants.REPO_NOTE_TYPE_KEY in notes \
                ...
                glance_repos.append(repo)

        return glance_repos

    def get_other_repositories(self, query_params, **kwargs):
        """
         Get a list of all the non glance repositories that match the specified query params
        ...
        for repo in all_repos:
            ...
            if notes.get(pulp_constants.REPO_NOTE_TYPE_KEY, None) != constants.REPO_NOTE_GLANCE:
                non_glance_repos.append(repo)

        return non_glance_repos
