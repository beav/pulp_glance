...
from pulp_glance.plugins.distributors.publish_steps import WebPublisher
...
def entry_point():
    ...
    return GlanceImageWebDistributor, plugin_config


class GlanceImageWebDistributor(Distributor):
    @classmethod
    def metadata(cls):
        """
        ...
        * types - List of all content type IDs that may be published using this
        ...
        return {
            ...
            'display_name': _('Glance Image Web Distributor'),
            'types': [constants.IMAGE_TYPE_ID]
        }

    def __init__(self):
        super(GlanceImageWebDistributor, self).__init__()
    ...
    def publish_repo(self, repo, publish_conduit, config):
        ...
        """
        _logger.debug('Publishing glance image repository: %s' % repo.id)
    ...
    def cancel_publish_repo(self):
        ...
        """
        _logger.debug('Canceling glance image repository publish')
        self.canceled = True
