...
from pulp_glance.plugins.distributors.distributor_web import GlanceImageWebDistributor, entry_point
...
class TestBasics(unittest.TestCase):
    ...
    def setUp(self):
        self.distributor = GlanceImageWebDistributor()
    ...
    def test_metadata(self):
        metadata = GlanceImageWebDistributor.metadata()
    ...
    @patch('pulp_glance.plugins.distributors.distributor_web.configuration.validate_config')
    ...
    @patch('pulp_glance.plugins.distributors.distributor_web.WebPublisher')
