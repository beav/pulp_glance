...
from pulp_glance.plugins.distributors import publish_steps
...
class TestWebPublisher(unittest.TestCase):
    ...
    @patch('pulp_glance.plugins.distributors.publish_steps.AtomicDirectoryPublishStep')
    @patch('pulp_glance.plugins.distributors.publish_steps.PublishImagesStep')
